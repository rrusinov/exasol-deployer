...
This directory contains templates for deploying Exasol across multiple cloud providers. The templates are organized to minimize code duplication while maintaining clarity.
